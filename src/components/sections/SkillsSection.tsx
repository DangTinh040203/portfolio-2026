...
const SKILL_CATEGORIES = [
  ...
  },
  {
    icon: Layout,
    title: "Frontend",
    skills: ["React.js", "Next.js", "TailwindCSS", "Framer Motion", "Redux", "shadcn/ui"],
    color: "text-cyan",
    bg: "bg-cyan/[.08]",
  },
  {
    icon: Database,
    title: "Backend",
    skills: ["Node.js", "NestJS", "Express.js", "Prisma", "PostgreSQL", "MySQL"],
    color: "text-green",
    bg: "bg-green/[.08]",
  },
  {
    icon: Cloud,
    title: "Cloud & DevOps",
    skills: ["AWS Services", "Google Cloud", "Docker", "Nginx", "CI/CD", "Turborepo"],
    color: "text-amber",
    bg: "bg-amber/[.08]",
  },
  {
    ...
    skills: ["Git/GitHub", "VS Code", "Postman", "Figma", "Jira", "Agile/Scrum"],
    color: "text-red",
    bg: "bg-red/[.08]",
  },
  {
    icon: Blocks,
    title: "Specialties",
    skills: ["REST APIs", "WebSocket", "AI/RAG Integration", "SEO", "Redis"],
